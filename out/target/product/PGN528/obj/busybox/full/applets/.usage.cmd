cmd_applets/usage := gcc -Wp,-MD,applets/.usage.d -Iapplets -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer  -I/root/oran/external/busybox/include -I/root/oran/external/busybox/include -Iinclude -o applets/usage /root/oran/external/busybox/applets/usage.c  

deps_applets/usage := \
  /root/oran/external/busybox/applets/usage.c \
