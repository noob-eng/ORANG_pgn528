cmd_applets/usage_pod := gcc -Wp,-MD,applets/.usage_pod.d -Iapplets -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer  -I/root/oran/external/busybox/include -I/root/oran/external/busybox/include -Iinclude -o applets/usage_pod /root/oran/external/busybox/applets/usage_pod.c  

deps_applets/usage_pod := \
  /root/oran/external/busybox/applets/usage_pod.c \
